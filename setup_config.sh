...
FGDB_GITTAG="v0.0.9"                 # Database Git repository tag/branch name
...
FGAPISERVER_GITTAG="v0.0.9"             # fgAPIServer Git repository tag/branch name
...
APISERVERDAEMON_GITTAG="v0.0.9"         # fgAPIServer Git repository tag/branch name
