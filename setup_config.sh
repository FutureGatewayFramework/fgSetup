...
FGDB_GITTAG="v0.0.10"                # Database Git repository tag/branch name
...
FGAPISERVER_GITTAG="v0.0.10"            # fgAPIServer Git repository tag/branch name
...
APISERVERDAEMON_GITTAG="v0.0.10"        # fgAPIServer Git repository tag/branch name
